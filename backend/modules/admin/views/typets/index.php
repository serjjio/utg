                ...
                'buttons' => [
                        'update' => function($url, $model, $key){
                            return Html::a('<span class="glyphicon glyphicon-pencil"></span>', '#root',
                                    [
                                        'data-attribute-url' => '/admin/typets/update/'.$key,
                                        'data-target'=>'#root',
                                        'class' => 'modalLink',
...
$beforePanel = <<<HTML
            ...
            <button class="btn btn-sm btn-create" data-attribute-url="/admin/typets/create"><i class="glyphicon glyphicon-plus"></i> Создать тип ТС</button>
HTML;
