...
<div class="marka-index">
    ...
    <!-- <p>
        <?= Html::a('Create Marka', ['create'], ['class' => 'btn btn-success']) ?>
    </p> -->
    <!-- <p>
        <?= Html::button('Create Marka', ['class' => 'btn btn-create', 'data-attribute-url'=>'marka/create'])?>
    </p> -->
                ...
                'buttons' => [
                        'update' => function($url, $model, $key){
                            return Html::a('<span class="glyphicon glyphicon-pencil"></span>', '#root',
                                    [
                                        'data-attribute-url' => '/admin/marka/update/'.$key,
                                        'data-target'=>'#root',
                                        'class' => 'modalLink',
